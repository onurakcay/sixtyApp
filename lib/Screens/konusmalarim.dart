              ...
              return RefreshIndicator(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    print("Bilgiler: " + currentChat.last_sent_message);
                    print("Bilgiler: " + currentChat.chattingProfilePicture);
                    print("Bilgiler: " + currentChat.chattingUsername);
                      ...
                      child: ListTile(
                        ...
                        subtitle: Text(currentChat.last_sent_message.length > 20
                            ? currentChat.last_sent_message.replaceRange(
                                    20,
                                    currentChat.last_sent_message.length,
                                    '...') +
                                " • " +
